...
public class ShittyUI extends JFrame {
	...
	private void buildInputPanel() {
		JComboBox<CSLTeamEnum> teamURLS = new JComboBox<CSLTeamEnum>();
		for (CSLTeamEnum teamUrl : CSLTeamEnum.values())
	...
	private class CSLGatherStatsAction extends AbstractAction {
		 ...
		 */
		private static final long serialVersionUID = 1L;
		private JComboBox<CSLTeamEnum> teamURLComboBox;
		private CSLTeamEnum previousTeamEnum;

		private CSLGatherStatsAction(JComboBox<CSLTeamEnum> teamURLComboBox) {
			super("Gather Stats");
			this.teamURLComboBox = teamURLComboBox;
		}

		public void actionPerformed(ActionEvent arg0) {
			final CSLTeamEnum teamEnum = (CSLTeamEnum) teamURLComboBox
					.getSelectedItem();
			...
			CSLTeamStatsGather gatherer = new CSLTeamStatsGather(
					teamEnum.getSchoolName(), teamEnum.getCSLTeamID(),
					System.out);
